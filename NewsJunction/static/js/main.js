...
var interval = setInterval(function() {
  ...
  if (timeLimit == 0) {
    ...
    timerElement.innerHTML = "We're sorry, but there seems to be an issue with the India news link at the moment. Please try selecting a different news source or category to continue browsing the latest news. If you continue to experience issues, please contact our support team for further assistance.";
  } else {
          ...
          <div class="card text-center justify-content-center bg-dark text-white mt-5" style="margin: auto;position: relative;border: 1px dashed #fff;">
            ...
            <div class="card-body">
              ...
              <select class="form-select" name="Additional Feature">
                ...
                <option value="Summerize">summarized</option> 
              </select>
